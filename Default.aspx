...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="Login.aspx" onclick="w3_close()" class="w3-bar-item w3-button">LOGIN</a>
</nav>
...
<div class="w3-container" style="padding:128px 16px" id="about">
  <h3 class="w3-center">ABOUT THE WEBSITENAME</h3>
  ...
  <div class="w3-row-padding w3-center" style="margin-top:64px">
    <div class="w3-quarter">
      ...
      <p class="w3-large">Routine</p>
      <p>Plan your activities of the day. Organized your daily calendar and publish it.</p>
    </div>
    <div class="w3-quarter">
      <i class="fa fa-heart w3-margin-bottom w3-jumbo"></i>
      <p class="w3-large">Trendinds</p>
      <p>Seek popular activities to do, become part of trends. Seek for another users routine.</p>
    </div>
    <div class="w3-quarter">
      <i class="fa fa-users w3-margin-bottom w3-jumbo"></i>
      <p class="w3-large">Community</p>
      <p>Share your routine and your interests with all the people. Finds friends to spend the day with the same activities.</p>
    </div>
    <div class="w3-quarter">
      <i class="fa fa-cog w3-margin-bottom w3-jumbo"></i>
      <p class="w3-large">Support</p>
      <p>advertising for your product, with the movement of your publications and wide suggestion for all users</p>
    </div>
  </div>
</div>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px">
  <div class="w3-row-padding">
    <div class="w3-col m6">
      <h3>Something.</h3>
      <p>Another thing<br/>tempor incididunt ut labore et dolore.</p>
...
<div class="w3-container w3-center w3-dark-grey" style="padding:128px 16px" id="pricing">
  <h3>PRICING FOR YOUR COMPANY</h3>
