<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeSession.aspx.cs" Inherits="HomeSession" %>
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="Default.aspx" onclick="w3_close()" class="w3-bar-item w3-button">LOG OUT</a>
    ...
    <div class="w3-container" style="padding:128px 16px">
         <h3 class="w3-center">SUGGESTED ACTIVITIES</h3>
      ...
      <div class="w3-card">
        <div class="w3-container">
          ...
          <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-plus-circle"></i> Add Activity</button></p>
        </div>
      </div>
    </div>
    </div>
    <div class="w3-container" style="padding:128px 16px">
         <h3 class="w3-center">POPULAR ACTIVITIES</h3>
        <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <div class="w3-container">
          <h3>John Doe</h3>
