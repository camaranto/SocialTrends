ï»¿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Search" %>
  ...
  <a href="Default.aspx" onclick="w3_close()" class="w3-bar-item w3-button">LOG OUT</a>
    ...
    <div class="search-container">
        <div class="bar-search-container">
            ...
            <asp:Button ID="NaughtyButton" CssClass="naughty-btn" runat="server" Text="I FEEL NAUGHTY" OnClick="NaughtyButton_Click"  />
        </div>
