                         ...
                         <div class="w3-card">
                           <div class="w3-container">
                              ...
                              <p class="w3-opacity">
                               ...
                               <asp:Button ID="Denied" runat="server" Text="DENIED" CssClass="btn-send" CommandArgument ='<% # Bind("UserID") %>' CommandName ="ButtonDenied" OnCommand="Elements_Command" />
                               <asp:Button ID="Accept" runat="server" Text="ACCEPT" CssClass="btn-send" CommandArgument ='<% # Bind("UserID") %>' CommandName ="ButtonAccept" OnCommand="Elements_Command" />
                            </div>
                          </div>
                  </div>
                </ItemTemplate>
